...
class News extends ActiveRecord
{
        ...
        return [
            ...
            'sitemap' => [
                ...
                'scope' => function ($model) {
                    $model->select(['url', 'created', 'date_redact', 'type']);
    ...
    public function rules()
    {
        return [
            ...
            [['user', 'category', 'type', 'redactor_id', 'status'], 'integer'],
    ...
    public static function getNews($where = [], $page = null)
    {
        ...
        for ($i = 0; $i < count($news); ++$i) {
            ...
            /**
             * Additional stuff for single news page (or when news represented as an article/videonews/etc.)
             ...
             */
            if (isset($where['url']) || isset($where['type']) && $where['type'] != self::NEWS_TYPE_DEFAULT) {
                ...
                if (isset($where['url'])) {
                    ...
                    if ($where['type'] == self::NEWS_TYPE_DEFAULT) {
