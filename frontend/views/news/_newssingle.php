        ...
        echo
            Html::tag(
                ...
                Html::tag(
                    'div',
                    Html::a(
                        '<img class="o-image grayscale" src="' . $recommendedNews['img'] . '"><span class="recommended__title">' . $recommendedNews['name'] . '</span>',
                        $url,
                        [
                ...
                Html::tag(
                    ...
                    Html::tag(
                        ...
                        Html::a(
                            ...
                            Html::tag(
                                'div',
                                /*HashtagHelper::processHashtagsFromText($news['text'])*/
                                '#hashTag1 #hashTag 2',
                                [
        ...
        echo
            Html::tag(
                ...
                Html::tag(
                    'div',
                    Html::a(
                        '<img class="o-image grayscale" src="' . $similarNews['img'] . '"><span class="similar__title">' . $similarNews['name'] . '</span>',
                        $url,
                        [
                            'class' => 'similar__link',
                            'ic-get-from' => $url,
...
/* --- Comments ---
Can be:
 - `WidgetCommentsDisqus::widget()` for thirdparty
 - `WidgetComments::widget(['elem_id' => $modelNews[0]['id'] ?? ''])` for in-built
*/
