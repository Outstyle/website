                ...
                Html::tag(
                    ...
                    Html::tag(
                        ...
                        Html::a(
                            ...
                            Html::tag(
                                'div',
                                /*HashtagHelper::processHashtagsFromText($events['text'])*/
                                '#hashTag1 #hashTag 2',
                                [
        ...
        echo
            Html::tag(
                ...
                Html::tag(
                    'div',
                    Html::a(
                        '<img class="o-image grayscale" src="' . $recommendedEvents['img'] . '"><span class="recommended__title">' . $recommendedEvents['title'] . '</span>',
                        $url,
                        [
